...
st.markdown("**Versão 1.0** | Registro e Gestão de Ouvidorias com auxílio de IA")
st.divider()
...
st.divider()
st.caption("SARO v1.0 | Ministério Público do Rio de Janeiro (Matheus Pereira Barreto [62006659])")
